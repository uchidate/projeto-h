...
export const groupsCategoriesHubs: ArchiveHub[] = [
    ...
    // grupos-4a-geracao-kpop removido em 22/09/2026: canibalizava
    // /blog/melhores-grupos-kpop-4a-geracao (mesma intenção de busca, título
    // quase idêntico), que é o conteúdo mais forte (2785 vs 958 palavras).
    // Consolidado por 301 em next.config.mjs. Conteúdo original (intro + FAQ)
    // preservado em .operacao/notas/dados/2026-09-22-conteudo-removido-guia-4a-geracao.txt
    // para eventual reaproveitamento editorial no post do blog.
    {
