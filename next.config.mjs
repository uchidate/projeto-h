...
const nextConfig = {
    ...
    async redirects() {
        return [
            ...
            { source: '/productions/begins-%e2%89%a0-youth', destination: '/productions/begins-youth', permanent: true },
            { source: '/productions/%e5%89%a3', destination: '/productions/ken', permanent: true },
            { source: '/productions/mal%c2%b7mo%c2%b7e-the-secret-mission', destination: '/productions/mal-mo-e-the-secret-mission', permanent: true },
            ...
            { source: '/productions/meus-84-m%c2%b2', destination: '/productions/meus-84-m2', permanent: true },
